...
(function() {
  var SOCKET_TEMPLATE, createServer, ejs, fs, getTempl, http, insertSocket, insertTempl, io, path, renderDir, res500, types, url, watcher;
  ...
  renderDir = function(realPath, files) {
    ...
    for (_i = 0, _len = files.length; _i < _len; _i++) {
      ...
      if (fs.statSync(_path).isDirectory()) {
        ...
        html.push("<li class='subdir folded'>                        <span class='folder'></span>                        <a href='#" + _path + "'onclick='toggleFold(this)'>" + file + "</a>                        " + (renderDir(_path, _files)) + "                    </li>");
      } else {
        _split = file.split('.');
